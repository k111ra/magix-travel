                ...
                <div class="packages-carousel">
                    ...
                    <div class="package-block">
                        <div class="inner-box">
                            ...
                            <div class="lower-box">
                                <div class="p-icon"><img src="{{ asset('frontend/assets/images/icons/t-icon-1.png') }}"
                    ...
                    <div class="package-block">
                        <div class="inner-box">
                            <div class="image-box">
                                <div class="image"><a href="tour-single.html"><img
                                            src="{{ asset('frontend/assets/images/resources/destinations/egypt.jpg') }}"
                                            alt="Egypt"></a>
                                </div>
                            </div>
                            <div class="lower-box">
                                <div class="p-icon"><img src="{{ asset('frontend/assets/images/icons/t-icon-2.png') }}"
                                        alt=""><span class="icon flaticon-hiking"></span></div>
                    ...
                    <div class="package-block">
                        <div class="inner-box">
                            <div class="image-box">
                                <div class="image"><a href="tour-single.html"><img
                                            src="{{ asset('frontend/assets/images/resources/destinations/italy.jpg') }}"
                                            alt="Italy"></a>
                                </div>
                            </div>
                            <div class="lower-box">
                                <div class="p-icon"><img src="{{ asset('frontend/assets/images/icons/t-icon-3.png') }}"
                                        alt=""><span class="icon flaticon-family"></span></div>
                    ...
                    <div class="package-block">
                        <div class="inner-box">
                            <div class="image-box">
                                <div class="image"><a href="tour-single.html"><img
                                            src="{{ asset('frontend/assets/images/resources/destinations/turkey.jpg') }}"
                                            alt="Turkey"></a>
                                </div>
                            </div>
                            <div class="lower-box">
                    ...
                    <div class="package-block">
                        <div class="inner-box">
                            <div class="image-box">
                                <div class="image"><a href="tour-single.html"><img
                                            src="{{ asset('frontend/assets/images/resources/destinations/japan.jpg') }}"
                                            alt="Japan"></a>
                                </div>
                            </div>
                            <div class="lower-box">
                                <div class="p-icon"><img src="{{ asset('frontend/assets/images/icons/t-icon-2.png') }}"
                                        alt=""><span class="icon flaticon-chinese-temple-1"></span></div>
                    ...
                    <div class="package-block">
                        <div class="inner-box">
                            <div class="image-box">
                                <div class="image"><a href="tour-single.html"><img
                                            src="{{ asset('frontend/assets/images/resources/destinations/brazil.jpg') }}"
                                            alt="Brazil"></a>
                                </div>
                            </div>
                            <div class="lower-box">
