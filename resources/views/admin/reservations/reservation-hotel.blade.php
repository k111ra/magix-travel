        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                   @forelse ($listesHotels as $reservation)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                {{-- <td>{{ optional($reservation->tour)->created_at }}</td>
                                ...
                                <td>
                                    <a href="{{route('reservation.hotel.show',$reservation->id)}}" class="btn btn-info btn-sm">
