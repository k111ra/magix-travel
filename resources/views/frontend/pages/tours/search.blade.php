...
@section('content')
    ...
    <section class="inner-banner">
        <div class="image-layer"
            style="background-image: url({{ asset('frontend/assets/images/resources/featured/banner-4.jpg') }});">
        </div>
                                    ...
                                    <div class="clearfix">
                                        <div class="pull-left">
                                            <div class="input">F CFA<input type="text"
                                                    class="property-amount property-amount-1" name="field-name" readonly>
                                            </div>
                                        </div>
                                        <div class="pull-right">
                                            <div class="input">F CFA<input type="text"
                                                    class="property-amount property-amount-2" name="field-name" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <li>
                                        <div class="cb-block"><input type="checkbox" id="cb-5"> <label
                                                for="cb-5"><span class="rating"><i class="fa-solid fa-star"></i><i
                                                        class="empty fa fa-star"></i><i class="empty fa fa-star"></i><i
                                                        class="empty fa fa-star"></i><i
                                                        class="empty fa fa-star"></i></span><span class="txt">Et
                                                    plus</span></label></div>
                                    </li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="cb-block"><input type="checkbox" id="cb-10"><label
                                                for="cb-10"><span class="txt">Visite de la ville</span></label>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <div class="cb-block"><input type="checkbox" id="cb-12"><label
                                                for="cb-12"><span class="txt">Visite de la plage</span></label>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <div class="cb-block"><input type="checkbox" id="cb-14"><label
                                                for="cb-14"><span class="txt">Randonnée pédestre</span></label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="w-inner">
                                ...
                                <ul>
                                    @foreach ($destinations as $destination)
                                        <li>
                                            <div class="cb-block"><input type="checkbox" id="cb-{{ $destination->id }}"
                                                    value="{{ $destination->id }}"><label
                                                    for="cb-{{ $destination->id }}"><span
                                                        class="txt">{{ $destination->name }}</span></label></div>
                                        </li>
                                        {{-- <li>
                ...
                <div class="content-side col-xl-8 col-lg-7 col-md-12 col-sm-12">
                    <div class="content-inner">
                        ...
                        <div class="packages">
                            <!--Block-->
                            @if ($tours->isEmpty())
                                <p>Aucun tour trouvé pour "{{ $query }}".</p>
                            @else
                                    ...
                                    <div class="package-block-two">
                                        ...
                                        <div class="inner-box">
                                            <div class="image-box">
                                                ...
                                                <div class="fav-btn"><a href="#"><span
                                                            class="far fa-heart"></span></a>
                                                </div>
                                                <div class="p-icon"><img
                                                        src="{{ asset('storage/' . json_decode($tour->images)[0]) }}"
                                                        alt=""><span class="icon flaticon-adventure"></span></div>
                                            </div>
                                            <div class="content-box">
                                                ...
                                                <div class="bottom-box clearfix">
                                                    <div class="duration"><i class="fa-solid fa-clock"></i>
                                                        {{ $tour->duree }} jour (s)
                                                    </div>
                                                    <div class="price">Prix &ensp;<span
                                                            class="amount">{{ number_format($tour->prix, 0, ',', ' ') }}
                                                            FCFA </span>
                                                    </div>
                                                </div>
                                            </div>
