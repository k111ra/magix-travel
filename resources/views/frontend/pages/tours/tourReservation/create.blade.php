                                    ...
                                    <div class="row">
                                        <div class="col-4"> 
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="tour_id" class="form-control" id="tour_id" value="{{ $tour->id }}" >
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group"> 
                                                <label for="destination_id">Localisation</label>
                                                <input type="text" value="" name="destination_id" class="form-control" id="destination_id" value="{{ $tour->destinations->name}}" >
                                            </div>
                                        </div>
                                        {{-- <div class="col-4">
                                            <div class="form-group">
