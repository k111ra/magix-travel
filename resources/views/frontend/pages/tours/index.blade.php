                        ...
                        <div class="sb-widget cbf-widget">
                            <div class="w-inner">
                                ...
                                <ul>
                                    ...
                                    @foreach ($types as $type)
                                        <li>
                                            <div class="cb-block"><input type="checkbox" id="cb-{{ $type->id }}"
                                                    value="{{ $type->id }}"><label for="cb-{{ $type->id }}"><span
                                                        class="txt">{{ $type->nom ?? '' }}</span></label></div>
                                        </li>
                                    @endforeach
                                ...
                                <div class="package-block-two">
                                    ...
                                    <div class="inner-box">
                                        ...
                                        <div class="content-box">
                                            ...
                                            <h5><a href="{{ route('single-tour', $tour->id) }}">{{ $tour->nom }} </a>
                                            </h5>
                                            ...
                                            <div class="bottom-box clearfix">
                                                ...
                                                <div class="price">Prix &ensp;<span
                                                        class="amount">{{ number_format($tour->prix, 0, ',', ' ') }} FCFA
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
