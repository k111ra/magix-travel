                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label for="tour_id">Compagnie airienne</label>
                                                    <input type="text"  name="vol_id" class="form-control" id="vol_id" value="{{ $vol->id }}" >
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <label for="destination_id">Localisation</label>
                                                    <input type="text"  name="destination_id" class="form-control" id="destination_id" value="{{  $vol->localisation  }}" >
                                                </div>
                                            </div>
                                            {{-- <div class="col-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number"  min="0" value="{{ $vol->prix }}" name="amount" class="form-control" id="amount" >
